			...
			<main className="container mx-auto px-4 py-12 lg:py-20">
				...
				<section className="text-center mb-16">
					...
					<p className="text-lg text-muted-foreground text-balance max-w-2xl mx-auto leading-relaxed mb-8">
						...
						experimentando la plataforma desde el rol que prefieras. Cada cuenta
						demo está preconfigurada con datos de ejemplo.
					</p>
				...
				<section className="max-w-3xl mx-auto text-center">
					<div className="bg-muted/50 rounded-2xl p-8 border border-border/50">
						...
						<p className="text-muted-foreground leading-relaxed mb-4">
							Las cuentas de demostración se reinician automáticamente cada 4
							horas para garantizar una experiencia limpia. Todos los cambios
							que realices durante la sesión serán temporales.
						</p>
